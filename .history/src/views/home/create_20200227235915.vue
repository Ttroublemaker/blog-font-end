  ...
  <div class="container">
    ...
    <div class="blog-edit-add">
      ...
      <div class="item">
        ...
        <el-upload class="upload-demo" action="http://192.168.1.105:3000/api/file/uploadFile/multiple" :on-preview="handlePreview" :on-remove="handleRemove" :on-success="uploadSuccess" :file-list="fileList" list-type="picture">
...
export default {
  ...
  methods: {
    ...
    uploadSuccess (response, file, fileList) {
      ...
      this.recImg = `http://192.168.1.105:3000/api/${url.destination}${url.filename}`
    },
    // 获取分类列表
    getArtClassifyList () {
