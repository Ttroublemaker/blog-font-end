  ...
  <div class="container">
    ...
    <div class="blog-edit-add">
      ...
      <div class="item">
        ...
        <el-upload class="upload-demo" action="http://localhost:8080/:3000/api/file/uploadFile/multiple" :on-preview="handlePreview" :on-remove="handleRemove" :on-success="uploadSuccess" :file-list="fileList" list-type="picture">
