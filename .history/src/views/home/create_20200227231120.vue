  ...
  <div class="container">
    ...
    <div class="blog-edit-add">
      ...
      <div class="item">
        ...
        <el-upload class="upload-demo" action="http://120.78.165.228/api/file/uploadFile/multiple" :on-preview="handlePreview" :on-remove="handleRemove" :file-list="fileList" list-type="picture">
