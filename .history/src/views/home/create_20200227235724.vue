  ...
  <div class="container">
    ...
    <div class="blog-edit-add">
      ...
      <div class="item">
        ...
        <el-upload class="upload-demo" action="http://192.168.1.105:8081//file/uploadFile/multiple" :on-preview="handlePreview" :on-remove="handleRemove" :on-success="uploadSuccess" :file-list="fileList" list-type="picture">
